...
MainPage::MainPage()
{
	...
	storageFileAsyncOperation->Completed = ref new AsyncOperationCompletedHandler<StorageFile^>(this, &MainPage::OnPickSingleFileAsyncCompleted);
}

// My Code
// FileOpenPicker's PickSingleFileAsync() method's completion handeler method
void MainPage::OnPickSingleFileAsyncCompleted(IAsyncOperation<StorageFile^>^ asyncOperation, AsyncStatus asyncStatus)
{
	// code
	// get chosen fil'e StorageFile object
	...
	if (m_File) // if user selcts a file and then presses "Open" button of FileOpenPicker
	{
		...
		randomAccessStreamAsyncOperation->Completed = ref new AsyncOperationCompletedHandler<IRandomAccessStream^>(this, &MainPage::OnOpenReadAsyncCompleted);
	}
	else // if user presses "Cancel" button of FileOpenPicker
	{
		IAsyncAction^ asyncAction = this->Dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler(this, &MainPage::OnFileOpenPickerCancelDispatcherCallback));
	}
}

void MainPage::OnFileOpenPickerCancelDispatcherCallback(void)
{
	// code
...
void MainPage::OnOpenReadAsyncCompleted(IAsyncOperation<IRandomAccessStream^>^ asyncOperation, AsyncStatus asyncStatus)
{
	// code
	...
	readData->Completed = ref new AsyncOperationCompletedHandler<UINT>(this, &MainPage::OnLoadAsyncCompleted);
}

void MainPage::OnLoadAsyncCompleted(IAsyncOperation<UINT>^ asyncOperation, AsyncStatus asyncStatus)
{
	// code
	...
	IAsyncAction^ asyncAction = this->Dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler(this,&MainPage::OnLoadAsyncCompletedDispatcherCallback));
}

void MainPage::OnLoadAsyncCompletedDispatcherCallback(void)
{
	// code
	...
	showAsyncOperation->Completed = ref new AsyncOperationCompletedHandler<IUICommand^>(this, &MainPage::OnShowAsyncCompleted);
}

void MainPage::OnShowAsyncCompleted(IAsyncOperation<IUICommand^>^ asyncOperation, AsyncStatus asyncStatus)
{
	// code
	...
	IAsyncAction^ asyncAction = this->Dispatcher->RunAsync(CoreDispatcherPriority::Normal, ref new DispatchedHandler(this, &MainPage::OnShowAsyncCompletedDispatcherCallback));
}

void MainPage::OnShowAsyncCompletedDispatcherCallback(void)
{
	// code
