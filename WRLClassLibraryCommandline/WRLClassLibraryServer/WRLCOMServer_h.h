...
/* at Thu Dec 25 16:53:08 2014
 */
/* Compiler settings for C:\Users\chetan\AppData\Local\Temp\WRLCOMServer.idl-c006cab8:
...
EXTERN_C const IID IID___x_ABI_CWRLCOMServer_CISum;
    ...
    namespace ABI {
        namespace WRLCOMServer {
            ...
            MIDL_INTERFACE("EC948884-BEBC-44EA-8D11-FA53F41825A6")
            ISum : public IInspectable
            {
            public:
                virtual HRESULT STDMETHODCALLTYPE SumOfTwoInteger( 
                    /* [in] */ int numberOne,
                    /* [in] */ int numberTwo,
    ...
    typedef struct __x_ABI_CWRLCOMServer_CISumVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *SumOfTwoInteger )( 
            __x_ABI_CWRLCOMServer_CISum * This,
            /* [in] */ int numberOne,
            /* [in] */ int numberTwo,
            /* [out][retval] */ int *psum);
...
#define __x_ABI_CWRLCOMServer_CISum_SumOfTwoInteger(This,numberOne,numberTwo,psum)	\
    ( (This)->lpVtbl -> SumOfTwoInteger(This,numberOne,numberTwo,psum) ) 
...
EXTERN_C const IID IID___x_ABI_CWRLCOMServer_CISubtract;
    ...
    namespace ABI {
        namespace WRLCOMServer {
            ...
            MIDL_INTERFACE("8249E6A4-2CF0-409F-A9A9-90E7C0DB667A")
            ISubtract : public IInspectable
            {
            public:
                virtual HRESULT STDMETHODCALLTYPE SubtractionOfTwoInteger( 
                    /* [in] */ int numberOne,
                    /* [in] */ int numberTwo,
                    /* [out][retval] */ int *psubtract) = 0;
    ...
    typedef struct __x_ABI_CWRLCOMServer_CISubtractVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE *SubtractionOfTwoInteger )( 
            __x_ABI_CWRLCOMServer_CISubtract * This,
            /* [in] */ int numberOne,
            /* [in] */ int numberTwo,
            /* [out][retval] */ int *psubtract);
...
#define __x_ABI_CWRLCOMServer_CISubtract_SubtractionOfTwoInteger(This,numberOne,numberTwo,psubtract)	\
    ( (This)->lpVtbl -> SubtractionOfTwoInteger(This,numberOne,numberTwo,psubtract) ) 
